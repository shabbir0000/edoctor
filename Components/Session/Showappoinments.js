    ...
    if (!doctorname || !doctorphone) {
      ...
      setDoc(doc(db, 'Emergency', userid), {
        ...
        .then(() => {
          ...
          setloading2(false);
          Alert.alert(
            'Alert Has Been Send To Doctor',
            'Please Check The Status On Booked Screen',
            [
              {
                text: 'OK',
                onPress: () => navigation.navigate('Home'),
      ...
      {userflag ? (
        <>
          <View style={tw` bg-white flex-1`}>
            ...
            <ScrollView
              style={tw`flex-1 mb-3 self-center `}
                  ...
                  <View style={tw`w-80 h-40`}>
                    ...
                    <View
                      ...
                      <Text numberOfLines={1} style={tw`w-70 font-light`}>
                        {data.selecteduser.hospitalname}
                      </Text>
                    </View>
                    ...
                    <View
                      ...
                      <Text numberOfLines={2} style={tw`w-70 font-light`}>
                        {data.selecteduser.hospitaladdress}
                      </Text>
                    </View>
                  </View>

                  <View
                    style={tw`h-35  mb-5  justify-between flex-col w-80 self-center `}>
                    ...
                    <View
                      style={tw` w-80 h-12   flex-row justify-between items-center self-center `}>
                      <View style={tw` w-35 h-10 justify-between self-center `}>
                        <TouchableOpacity
                          ...
                          <View
                            style={tw`h-10 w-35 items-center rounded-3xl  justify-center border border-blue-400`}>
                            <Text
                              style={tw`text-sm text-gray-500  text-center font-normal`}>
                      ...
                      <Dropdown
                        style={[
                          tw`h-10 w-40 border border-blue-500  bg-white rounded-3xl`,
              ...
              <ScrollView
                ...
                {GetData.map((data, index) => (
                  <TouchableOpacity disabled={true} key={index}>
                    <View
                      style={[
                        tw`border flex-col justify-center items-center w-80 h-60 rounded-md self-center mt-5`,
                        {borderColor: '#00B1E7'},
                      ]}>
                      <View
                        style={tw`h-15 w-70 flex-row items-center justify-between `}>
                        <View>
                          <Text
                            numberOfLines={1}
                      ...
                      <View
                        style={tw`h-10  justify-between items-center flex-row w-70`}>
                        <Text
                          numberOfLines={1}
                      ...
                      {loading1 && data.selecteduser.userid === updatedocid ? (
                        ...
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            updatedoc(
                              data.selecteduser.status === 'confirmed'
                                ? 'cancelled'
                                : 'confirmed',
                          ...
                          <View
                            style={tw` rounded-md bg-slate-200 w-70 items-center justify-center h-10 mt-5 `}>
                            <Text>
                              {data.selecteduser.status === 'confirmed'
                                ? 'CANCEL BOOKING'
                                : 'ACCEPT AGAIN'}
